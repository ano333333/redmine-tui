...
fn move_worker_action_dispatches_worker_actions_without_extra_notice() {
    ...
    let spawner = CompletionSpawner::new(vec![Action::Journal(JournalAction::FailRemoteUpload {
        issue_id: IssueId::new(3),
        journal_id: JournalId::new(1),
...
fn move_focus_down(app: &mut AppComponent<'_>, dispatcher: Rc<RefCell<Dispatcher>>, count: usize) {
    for _ in 0..count {
        app.process_event(
