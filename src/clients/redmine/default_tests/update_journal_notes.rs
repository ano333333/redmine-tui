...
fn update_journal_notes_sends_redmine_put_request() {
    ...
    block_on(client.update_journal_notes(JournalId::new(42), "updated journal notes")).unwrap();
}
...
fn update_journal_notes_maps_unauthorized_with_response_context() {
    ...
    let actual_error = expect_error(
        block_on(client.update_journal_notes(JournalId::new(42), "updated journal notes")),
